...
def discriminator(x, is_training=True, reuse=False):
    ...
    with tf.variable_scope("discriminator", reuse=reuse):
        ...
        embeding = conv2d(net, output_dim=64, kernel=(7, 7), stride=(1, 1), padding='VALID', activation='relu', use_bn=True, is_training=is_training, name='conv3')
        net = conv2d(embeding, output_dim=64*7*7, kernel=(1, 1), stride=(1, 1), activation='relu', use_bn=True,is_training=is_training, name='d_conv2')
